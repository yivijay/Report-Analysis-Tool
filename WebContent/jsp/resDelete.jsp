...
return false;
			...
			else
			{
				...
				var lDiv;
				var lRoot;
				var lTableURL = "/AdministratorModule/jsp/resDelTestList.jsp?ProjectName="+pPrjName;
...
<form name="form1" ACTION="/AdministratorModule/jsp/resDel.jsp"
	METHOD="POST" onSubmit="return validateForm()">
<h1><font size=+2 color=BLUE>Delete Test Results</font></h1>
<hr>
	...
	<tr>
		...
		<td><SELECT name="ProjectName"
			...
			<OPTION VALUE="Select">--Select-- <%
				String l_PrNames = ResultsDeleteEngine.getProjectName();
				String l_Tokens ="";
			...
			<OPTION VALUE="<%=l_Tokens%>"><%=l_Tokens%> <%					
				}
				%>
